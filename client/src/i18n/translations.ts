...
export const translations = {
  en: {
    ...
    days: 'days',
    grossProfit: 'Gross P&L',
    commissionFee: 'Commission',
    taxPaid: 'Tax (25%)',
    netProfit: 'Net P&L',
    plannedTP: 'Planned Take Profit',
    plannedSL: 'Planned Stop Loss',
    actualExit: 'Actual Exit',
    planAccuracy: 'Plan Accuracy',
    hitTP: 'Hit Take Profit target',
    hitSL: 'Hit Stop Loss',
    exitedBetween: 'Exited between TP and SL',
    exitedAboveTP: 'Exited above Take Profit!',
    exitedBelowSL: 'Exited below Stop Loss',
    profitTrade: 'Profitable Trade',
    lossTrade: 'Loss Trade',
    breakEvenTrade: 'Break Even',
    noMatchingSell: 'Position still open or no matching sell found',
    noMatchingBuy: 'No matching buy record',
    legacyExitNoFees: 'Recorded before fees & tax were charged on automatic exits - figures are gross',
    autoExitTP: 'Auto: Take Profit',
    autoExitSL: 'Auto: Stop Loss',
    // Position sizing rationale
    sizedByRisk: 'Sized so a stop-out costs {risk}% of your equity (risk budget {budget}).',
    sizedByConcentration: 'Capped at 20% of equity — the stop is tight enough that the risk rule would allow more.',
    sizedByCash: 'Limited by available cash after the reserve.',
    sizedByHeat: 'Reduced: your total open risk is near the portfolio limit.',
    sizedByMaxPositions: 'Blocked: you are at the maximum number of open positions.',
    sizedBelowMinimum: 'Too small to be worth the round-trip commission.',
    // Recommendation performance
    recPerformanceTitle: 'Do the recommendations work?',
    recPerformanceSubtitle: 'Measured outcomes of past BUY NOW and WAIT FOR DIP calls',
    recHorizon: '{days} trading days',
    recOverall: 'All recommendations',
    recHitTarget: 'Hit target',
    recHitStop: 'Hit stop',
    recAvgR: 'Avg R',
    recSamples: 'calls',
  ...
  he: {
    ...
    buyDetails: 'פרטי קנייה',
    sellDetails: 'פרטי מכירה',
    buyPrice: 'מחיר קנייה',
    sellPrice: 'מחיר מכירה',
    holdingDays: 'תקופת החזקה',
    days: 'ימים',
    grossProfit: 'רווח/הפסד ברוטו',
    commissionFee: 'עמלה',
    taxPaid: 'מס (25%)',
    netProfit: 'רווח/הפסד נטו',
    plannedTP: 'יעד רווח מתוכנן',
    plannedSL: 'סטופ לוס מתוכנן',
    actualExit: 'יציאה בפועל',
    planAccuracy: 'דיוק התוכנית',
    hitTP: 'הגיע ליעד הרווח',
    hitSL: 'הגיע לסטופ לוס',
    exitedBetween: 'יצא בין TP ל-SL',
    exitedAboveTP: 'יצא מעל יעד הרווח!',
    exitedBelowSL: 'יצא מתחת לסטופ לוס',
    profitTrade: 'עסקה רווחית',
    lossTrade: 'עסקה הפסדית',
    breakEvenTrade: 'איזון',
    noMatchingSell: 'הפוזיציה עדיין פתוחה או לא נמצאה מכירה תואמת',
    noMatchingBuy: 'לא נמצאה רשומת קנייה תואמת',
    legacyExitNoFees: 'נרשם לפני שיציאות אוטומטיות חויבו בעמלה ומס — הנתונים ברוטו',
    autoExitTP: 'אוטומטי: יעד רווח',
    autoExitSL: 'אוטומטי: סטופ לוס',
    // Position sizing rationale
    sizedByRisk: 'הגודל נקבע כך שיציאה בסטופ תעלה {risk}% מההון (תקציב סיכון {budget}).',
    sizedByConcentration: 'הוגבל ל-20% מההון — הסטופ צמוד מספיק שכלל הסיכון היה מאפשר יותר.',
    sizedByCash: 'הוגבל לפי המזומן הפנוי אחרי הרזרבה.',
    sizedByHeat: 'הוקטן: סך הסיכון הפתוח שלך קרוב למגבלת התיק.',
    sizedByMaxPositions: 'נחסם: הגעת למספר המרבי של פוזיציות פתוחות.',
    sizedBelowMinimum: 'קטן מדי מכדי להצדיק את עמלת הסבב.',
    // Recommendation performance
    recPerformanceTitle: 'האם ההמלצות עובדות?',
    recPerformanceSubtitle: 'תוצאות נמדדות של המלצות BUY NOW ו-WAIT FOR DIP קודמות',
    recHorizon: '{days} ימי מסחר',
    recOverall: 'כל ההמלצות',
    recHitTarget: 'הגיע ליעד',
    recHitStop: 'הגיע לסטופ',
    recAvgR: 'R ממוצע',
    recSamples: 'המלצות',
